...
#matching the keypoints found with sift for the two outer right images
#and using the cross check to keep the common matches
sift_matches01 = bf.match(des0, des1)
sift_matches10 = bf.match(des1, des0)

cross_check01 = cross_checking(sift_matches10, sift_matches01)

#matching the keypoints found with sift for the two outer left images
#and using the cross check to keep the common matches
sift_matches23 = bf.match(des2, des3)
sift_matches32 = bf.match(des3, des2)

cross_check23 = cross_checking(sift_matches32, sift_matches23)
...
kp01, des01 = sift.detectAndCompute(merged1.copy(), None)
imgkp01 = cv2.drawKeypoints(merged1.copy(), kp01, merged1.copy())

#υπολογισμός keypoint-descriptor για το αριστερό ζεύγος
kp23, des23 = sift.detectAndCompute(merged2.copy(), None)
imgkp23 = cv2.drawKeypoints(merged2.copy(), kp23, merged2.copy())

#mathcing keypoints & cross checking
sift_matches0123 = bf.match(des01, des23)
sift_matches2301 = bf.match(des23, des01)

cross_check0123 = cross_checking(sift_matches2301, sift_matches0123)
